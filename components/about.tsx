...
const About: NextPage = () => {
  return (
    <div className="self-stretch bg-gray-300 flex flex-col py-[100px] px-[94px] items-start justify-start gap-[27px] text-left text-45xl text-white font-poppins sm:gap-[10px] sm:pl-4 sm:pr-4 sm:box-border">
