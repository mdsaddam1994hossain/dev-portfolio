  ...
  return (
    ...
    >
      <h4
        ...
        className="m-0 self-stretch relative text-[56px] text-[inherit] tracking-[-0.5px] leading-[80px] font-semibold font-inherit sm:text-[48px] sm:leading-[64px]"
      >
        About me
      </h4>
      <p
        ...
        data-aos-delay="200"
        data-aos-duration="500"
        className="m-0 self-stretch relative text-17xl tracking-[1px] leading-[56.5px] text-gray-600 sm:text-5xl sm:leading-[40px]"
      >
