...
const CardContainer: NextPage<CardContainerType> = ({
  ...
  return (
    <div className="self-stretch flex-1 rounded-3xs flex flex-col py-[49px] px-5 items-center justify-start gap-[40px] bg-[url(/testimonials@3x.png)] bg-cover bg-no-repeat bg-[top] text-center text-mini text-gray-300 font-poppins md:flex-[unset] md:self-stretch">
